...
При этом достаточно будет экранировать только ВЧ тракт, так как остальная схема будет достаточно защищена от паразитных излучений.% из-за \sout{стукачества, лол} экранирования отверстиями. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth, height=0.4\textheight, keepaspectratio]{CellsCutout.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth, height=0.4\textheight, keepaspectratio]{BoardCase.pdf}
