...
\input{include/presentation/preamble}
	...
	\begin{frame}
		...
		\begin{center}
			\begin{figure}
				...
				%
				\begin{subfigure}{0.5\textwidth}
					\includegraphics[width=0.9\textwidth, trim={0cm 0cm 6.1cm 0.8cm}, clip]{LTC-power-limits.pdf}
				\end{subfigure}
			\end{figure}
...
\subsection{Согласование компонентов}
	...
	\begin{frame}
		...
		\includegraphics[width=1.1\textwidth, height=\textheight, keepaspectratio]{LNA_Response_Z.pdf}
	...
	\begin{frame}
		...
		\centering
		\hspace*{-0.075\textwidth}%
		\includegraphics[width=1.15\textwidth, height=\textheight, keepaspectratio]{Utilities.png}
	...
	\begin{frame}
		...
		\centering
		\hspace*{-0.075\textwidth}%
		\includegraphics[width=0.6\textwidth, height=0.37\textheight, keepaspectratio]{LNA_Response.pdf}%
		\includegraphics[width=0.6\textwidth, height=0.37\textheight, keepaspectratio]{LNA_VSWR.pdf}
	\end{frame}
...
\subsection{Системное моделирование}
	...
	\begin{frame}
		...
		\centering
		\hspace*{-0.075\textwidth}%
		\includegraphics[width=1.15\textwidth, height=\textheight, keepaspectratio]{SystemSch.pdf}
	...
	\begin{frame}
		...
		\centering
		\hspace*{-0.075\textwidth}%
		\includegraphics[width=1.15\textwidth, height=\textheight, keepaspectratio]{SystemResponse.pdf}
...
\subsection{Топология}
	...
	\begin{frame}
		...
		\framesubtitle{\insertsubsection}
		\centering
		\includegraphics[width=\textwidth, height=0.9\textheight, keepaspectratio]{2LayerAll.pdf}	
